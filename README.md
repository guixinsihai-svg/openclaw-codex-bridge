...
This bridge has been used to run 34 local tasks, including directory checks, UTF-8 Chinese task tests, project file creation, documentation updates, smoke tests, and GitHub Actions CI setup.

This is still an early-stage local MVP, not a full OpenClaw plugin or production n8n workflow.

## CI

This repository includes a minimal GitHub Actions smoke test that runs `tests/smoke-test.ps1` on push and pull request to the `main` branch.
